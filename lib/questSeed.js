...
const QUEST_SEED = [
  ...
  { id: 'seed_med_3', text: 'Check off your medicine time today', category: 'medicine', reward: REWARDS.medicine, completed: false },
  ...
  { id: 'seed_rout_3', text: 'Get a full night of sleep', category: 'routine', reward: REWARDS.routine, completed: false },
  ...
  { id: 'seed_safe_3', text: 'Stay close to an adult during water play', category: 'safety', reward: REWARDS.safety, completed: false },
